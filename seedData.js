...
//     const queryEntry = `UPDATE answers SET photos = photos || $2::jsonb WHERE answer_id = $1;`;
//     const photosArr = [row[('answer_id', photo)]];
//     db.query(queryEntry, photosArr, (err, results) => {
//       if (err) {
//         count++;
//         if ((count % 100, 000 === 0)) {
//           console.log(count);
